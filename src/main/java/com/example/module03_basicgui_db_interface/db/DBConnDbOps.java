 ...
 */
public class DBConnDbOps {
    final String MYSQL_SERVER_URL = "jdbc:mysql://csc311adamesjava65.mysql.database.azure.com/";
    final String DB_URL = MYSQL_SERVER_URL+"DBname";
    final String USERNAME = "adamy";
    final String PASSWORD = "fair123$";
